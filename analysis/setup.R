...
rof <- cbind(expand.grid(candidate=c("left rof", "center rof", "right rof"), year=2014), `Airport expansion` = c(10,50,90), `Finance & Budget` = c(10,50,90), `Transit` = c(10,50,90), `Transportation` = c(10,50,90), `Waste management` = c(10,50,90), score=c(10,50,90))
