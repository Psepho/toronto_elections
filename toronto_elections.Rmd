...
```{r issue_setup, warning=FALSE, cache=TRUE, message=FALSE}
...
```{r issue_map, echo=FALSE, fig.cap="The distribution of votes, based on specific issues.", echo=FALSE, results='hide', message=FALSE}
