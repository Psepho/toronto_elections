...
In this paper, we describe attempts to effectively model--at a neighbourhood level--which candidates voters are likely to support in the 2014 Toronto mayoral race. All of our data is based upon publicly available sources. So, the resources required are _far_ less than those of polling or creating voter databases. Through these attempts, we explore the limits of such data and how they can best be used for informing candiates' strategies.
