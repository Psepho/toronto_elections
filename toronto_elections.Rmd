...
```{r pca_map, fig.cap="The distribution of PCA scores, based on the 2011 Census. For each component, high loadings are correlated with left positions.", echo=FALSE, results='hide', message=FALSE, fig.width=7}
# Map components ----------------------------------------------------------
